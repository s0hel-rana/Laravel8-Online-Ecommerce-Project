...
<body class="home-page home-01 ">
									...
									@auth
										@if(Auth::user()->utype==='ADM')
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													<li class="menu-item" >
														<a title="Pound (GBP)" href="{{ route('admin.dashborad') }}">Dashboard</a>
													</li>
													<li class="menu-item" >
										...
										@else
											<li class="menu-item menu-item-has-children parent" >
												...
												<ul class="submenu curency" >
													<li class="menu-item" >
														<a title="Pound (GBP)" href="{{ route('user.dashborad') }}">Dashboard</a>
													</li>
													<li class="menu-item" >
														<a href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" >Logout</a>
													</li>
				...
				<div class="container">
					<div class="mid-section main-info-area">
						...
						<div class="wrap-icon right-section">
							...
							@livewire('wishlish-count-component')
									...
									<div class="wrap-contact-detail">
										<ul>
											<li>
												...
												<p class="contact-txt">45 Grand Central Terminal Dhaka,NY 1017 Bangladesh</p>
											</li>
											<li>
												<i class="fa fa-phone" aria-hidden="true"></i>
												<p class="contact-txt">(+880) 1911153010 - (+880) 1713616087</p>
											</li>
											<li>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-hotline-footer">
										...
										<b class="phone-number">(+880) 1911153010 - (+880) 1713616087</b>
									</div>
								</div>
							</div>
    ...
    <script src="https://cdn.tiny.cloud/1/253bdkww3xgooy9td4nlgzsnu9bma95vmv98rkxomo6y0pr5/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>
