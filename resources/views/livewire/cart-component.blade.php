			...
			<div class=" main-content-area">
				...
				<div class="summary">
					<div class="order-summary">
                        ...
                        <p class="summary-info"><span class="title">Subtotal with Discount ({{config('cart.tex')}}%)</span><b class="index">${{number_format($subtotalAfterDiscount,2)}}</b></p>
                        <p class="summary-info"><span class="title">Tex ({{config('cart.tex')}}%)</span><b class="index">${{number_format($taxAfterDiscount,2)}}</b></p>
